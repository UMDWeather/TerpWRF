...
filename='surface'
title ='MSLP / 1000mb-500mb thickness / 3-hr precip'
...
def plot(variables,prev_vars,pltenv):
    ...
    thck = (variables['GHT_PL'][time][lvl_500]-h1000)/10
    ...
    precip -= (prev_vars['RAINNC'][time]+prev_vars['RAINC'][time])*0.03937
